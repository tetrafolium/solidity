...
public:
    ...
    void setCompiledContracts(std::map<ContractDefinition const*, eth::Assembly const*> const& _contracts) {
    ...
    void setInheritanceHierarchy(std::vector<ContractDefinition const*> const& _hierarchy) {

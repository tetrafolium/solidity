...
parseContractDefinition(Token::Value _expectedKind);
...
ASTPointer<FunctionDefinition>
parseFunctionDefinition(ASTString const *_contractName);
...
ASTPointer<TypeName> parseTypeNameSuffix(ASTPointer<TypeName> type,
...
parseInlineAssembly(ASTPointer<ASTString> const &_docString = {});
ASTPointer<IfStatement>
parseIfStatement(ASTPointer<ASTString> const &_docString);
ASTPointer<WhileStatement>
parseWhileStatement(ASTPointer<ASTString> const &_docString);
ASTPointer<WhileStatement>
parseDoWhileStatement(ASTPointer<ASTString> const &_docString);
ASTPointer<ForStatement>
parseForStatement(ASTPointer<ASTString> const &_docString);
/// A "simple statement" can be a variable declaration statement or an
/// expression statement.
ASTPointer<Statement>
parseSimpleStatement(ASTPointer<ASTString> const &_docString);
...
ASTPointer<Expression>
parseExpression(ASTPointer<Expression> const &_lookAheadIndexAccessStructure =
			ASTPointer<Expression>());
...
std::pair<std::vector<ASTPointer<Expression> >,
...
ASTPointer<TypeName> typeNameIndexAccessStructure(
	...
	std::vector<std::pair<ASTPointer<Expression>, SourceLocation> > const
	&_indices);
...
/// Flag that signifies whether '_' is parsed as a PlaceholderStatement or a
/// regular identifier.

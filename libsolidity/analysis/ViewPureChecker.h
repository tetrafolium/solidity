...
public:
ViewPureChecker(std::vector<std::shared_ptr<ASTNode> > const &_ast,
...
/// Creates appropriate warnings and errors and sets @a
/// m_currentBestMutability.
void reportMutability(StateMutability _mutability,

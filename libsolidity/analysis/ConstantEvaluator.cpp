	...
	if (left && right) {
		...
		if (!commonType)
			m_errorReporter.fatalTypeError(
				...
				" not compatible with types " + left->toString() + " and " +
				right->toString());
		setType(_operation, Token::isCompareOp(_operation.getOperator())
...
void ConstantEvaluator::setType(ASTNode const &_node,

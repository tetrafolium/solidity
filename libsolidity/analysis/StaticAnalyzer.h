 ...
 * In this context, static analysis is anything that can produce warnings which
 * can help programmers write cleaner code. For every warning generated here, it
 * has to be possible to write equivalent code that does not generate the
 * warning.
 */

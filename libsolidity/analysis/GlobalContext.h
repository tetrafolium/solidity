...
/**
 * Container for all global objects which look like AST nodes, but are not part
 * of the AST that is currently being compiled.
 * @note must not be destroyed or moved during compilation as its objects can be

...
string AsmPrinter::operator()(assembly::Literal const &_literal) {
  ...
  case LiteralKind::Boolean:
    return ((_literal.value == "true") ? "true" : "false") +
           appendTypeName(_literal.type);
...
operator()(assembly::FunctionalInstruction const &_functionalInstruction) {
  ...
  return boost::to_lower_copy(
             instructionInfo(_functionalInstruction.instruction).name) +
         "(" +
         boost::algorithm::join(
             _functionalInstruction.arguments |
...
string AsmPrinter::
operator()(assembly::VariableDeclaration const &_variableDeclaration) {
  string out = "let ";
  out += boost::algorithm::join(
      _variableDeclaration.variables |
          boost::adaptors::transformed([this](TypedName variable) {
...
string AsmPrinter::
operator()(assembly::FunctionDefinition const &_functionDefinition) {

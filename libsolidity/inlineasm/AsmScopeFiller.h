...
bool operator()(assembly::Literal const &) {
	return true;
}
bool operator()(assembly::Identifier const &) {
	return true;
}
bool operator()(assembly::FunctionalInstruction const &) {
	return true;
}
...
bool operator()(assembly::FunctionCall const &) {
	return true;
}
...
private:
bool registerVariable(TypedName const &_name, SourceLocation const &_location,
                      Scope &_scope);

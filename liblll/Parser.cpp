...
void dev::eth::killBigints(sp::utree const& _this)
{
    ...
    case sp::utree_type::list_type:
        for (auto const& i: _this) killBigints(i);
        break;
...
void dev::eth::debugOutAST(ostream& _out, sp::utree const& _this)
{
    ...
    case sp::utree_type::string_type:
        _out << "\"" << _this.get<sp::basic_string<boost::iterator_range<char const*>, sp::utree_type::string_type>>() << "\"";
        break;
    case sp::utree_type::symbol_type:
        _out << _this.get<sp::basic_string<boost::iterator_range<char const*>, sp::utree_type::symbol_type>>();
        break;
    case sp::utree_type::any_type:

...
BOOST_AUTO_TEST_CASE(smoke_test) {
  ...
  sourceIndices["a"] = 1;
  Json::Value astJson =
      ASTJsonConverter(true, sourceIndices).toJson(c.ast("a"));
...
BOOST_AUTO_TEST_CASE(source_location) {
  ...
  BOOST_CHECK_EQUAL(astJson["children"][0]["children"][0]["name"],
                    "FunctionDefinition");
...
BOOST_AUTO_TEST_CASE(inheritance_specifier) {
  ...
  BOOST_CHECK_EQUAL(astJson["children"][1]["children"][0]["name"],
                    "InheritanceSpecifier");
  BOOST_CHECK_EQUAL(astJson["children"][1]["children"][0]["src"], "30:2:1");
  BOOST_CHECK_EQUAL(
      astJson["children"][1]["children"][0]["children"][0]["name"],
      "UserDefinedTypeName");
  BOOST_CHECK_EQUAL(astJson["children"][1]["children"][0]["children"][0]
                           ["attributes"]["name"],
                    "C1");
}
...
BOOST_AUTO_TEST_CASE(modifier_definition) {
  CompilerStack c;
  c.addSource("a",
              "contract C { modifier M(uint i) { _; } function F() M(1) {} }");
  c.parseAndAnalyze();
  map<string, unsigned> sourceIndices;
  sourceIndices["a"] = 1;
  Json::Value astJson =
...
BOOST_AUTO_TEST_CASE(modifier_invocation) {
  ...
  BOOST_CHECK_EQUAL(modifier["children"][0]["attributes"]["type"],
                    "modifier (uint256)");
...
BOOST_AUTO_TEST_CASE(placeholder_statement) {
  ...
  Json::Value placeholder =
      astJson["children"][0]["children"][0]["children"][1]["children"][0];
...
BOOST_AUTO_TEST_CASE(non_utf8) {
  ...
  Json::Value astJson =
      ASTJsonConverter(true, sourceIndices).toJson(c.ast("a"));
  Json::Value literal = astJson["children"][0]["children"][0]["children"][2]
  ...
  BOOST_CHECK(literal["attributes"]["type"].asString().find("invalid") !=
              string::npos);
}
...
BOOST_AUTO_TEST_CASE(function_type) {
  ...
  BOOST_CHECK_EQUAL(argument["attributes"]["type"],
  ...
  BOOST_CHECK_EQUAL(retval["attributes"]["type"],
...
BOOST_AUTO_TEST_CASE(documentation) {
  ...
  c.addSource("b", "/**This contract is empty"
  ...
  Json::Value astJsonA =
      ASTJsonConverter(true, sourceIndices).toJson(c.ast("a"));
  Json::Value documentationA =
      astJsonA["children"][0]["attributes"]["documentation"];
  BOOST_CHECK_EQUAL(documentationA, "This contract is empty");
  Json::Value astJsonB =
      ASTJsonConverter(true, sourceIndices).toJson(c.ast("b"));
  Json::Value documentationB =
      astJsonB["children"][0]["attributes"]["documentation"];
  BOOST_CHECK_EQUAL(documentationB,
                    "This contract is empty and has a line-breaking comment.");

...
Json::Value compileSingle(string const &_input) {
	string output(
		compileJSON(_input.c_str(), dev::test::Options::get().optimize));
	Json::Value ret;
...
Json::Value compileMulti(string const &_input, bool _callback) {
	string output(
		_callback ? compileJSONCallback(_input.c_str(),
		                                dev::test::Options::get().optimize, NULL)
		: compileJSONMulti(_input.c_str(),
...
BOOST_AUTO_TEST_CASE(basic_compilation) {
	...
	BOOST_CHECK_EQUAL(dev::jsonCompactPrint(result),
	...
	BOOST_CHECK_EQUAL(
		...
		"60606040523415600e57600080fd5b603580601b6000396000f3006060604052600080fd"
		"00");
	...
	BOOST_CHECK_EQUAL(dev::jsonCompactPrint(result["sources"]["fileA"]["AST"]),
	                  "{\"attributes\":{\"absolutePath\":\"fileA\","
	                  "\"exportedSymbols\":{\"A\":[1]}},"
	                  "\"children\":[{\"attributes\":{\"baseContracts\":[null],"
	                  "\"contractDependencies\":[null],"
	                  "\"contractKind\":\"contract\",\"documentation\":null,"
	                  "\"fullyImplemented\":true,\"linearizedBaseContracts\":[1],"
	                  "\"name\":\"A\",\"nodes\":[null],\"scope\":2},\"id\":1,"
	                  "\"name\":\"ContractDefinition\","
	                  "\"src\":\"0:14:0\"}],\"id\":2,\"name\":\"SourceUnit\","
	                  "\"src\":\"0:14:0\"}");
}
...
BOOST_AUTO_TEST_CASE(single_compilation) {
	...
	BOOST_CHECK_EQUAL(
		...
		"\"contractKind\":\"contract\",\"documentation\":null,"
		"\"fullyImplemented\":true,\"linearizedBaseContracts\":[1],"
		"\"name\":\"A\",\"nodes\":[null],\"scope\":2},\"id\":1,\"name\":"
		"\"ContractDefinition\","
		"\"src\":\"0:14:0\"}],\"id\":2,\"name\":\"SourceUnit\",\"src\":\"0:14:"
		"0\"}");
}
...
BOOST_AUTO_TEST_CASE(standard_compilation) {
	...
	// Only tests some assumptions. The StandardCompiler is tested properly in
	// another suite.

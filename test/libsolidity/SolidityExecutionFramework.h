 ...
 * @date 2014
 * Framework for executing Solidity contracts and testing them against C++
 * implementation.
 */
...
public:
  ...
  virtual bytes const &compileAndRunWithoutCheck(
      ...
      std::map<std::string, dev::test::Address> const &_libraryAddresses =
          std::map<std::string, dev::test::Address>()) override {
    ...
    eth::LinkerObject obj = m_compiler.object(

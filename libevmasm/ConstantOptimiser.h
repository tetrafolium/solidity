...
/**
 * Abstract base class for one way to change how constants are represented in
 * the code.
 */
...
/**
 * Optimisation method that pushes the constant to the stack literally. This is
 * the default method, i.e. executing it does not alter the Assembly.
 */
...
/**
 * Method that stores the data in the .data section of the code and copies it to
 * the stack.
 */

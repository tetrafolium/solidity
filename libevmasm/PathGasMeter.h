...
/**
 * Computes an upper bound on the gas usage of a computation starting at a
 * certain position in a list of AssemblyItems in a given state until the
 * computation stops. Can be used to estimate the gas usage of functions on any
 * given input.
 */
class PathGasMeter {
public:

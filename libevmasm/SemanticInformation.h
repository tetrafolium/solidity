...
/**
 * Helper functions to provide context-independent information about assembly
 * items.
 */
struct SemanticInformation {
  /// @returns true if the given items starts a new block for common
  /// subexpression analysis.
  static bool breaksCSEAnalysisBlock(AssemblyItem const &_item);
  /// @returns true if the item is a two-argument operation whose value does not
  ...
  /// @returns false if the value put on the stack by _item depends on anything
  /// else than the information in the current block header, memory, storage or
  /// stack.
